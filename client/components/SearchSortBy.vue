<template>
  <label class="text-base flex flex-row items-center">
    ...
    <ais-sort-by
      ...
      :class-names="{
        'ais-SortBy': 'px-2 bg-white text-base border border-gray-400 dark:bg-black dark:border-white dark:text-white px-1 rounded-xs scheme-light dark:scheme-dark',
